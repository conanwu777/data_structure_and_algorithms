...
int main(void)
{
	...
	--------------------*/
	struct s_dict *dict = dictInit(99991);
	printf("Dict initialized!\n");
	...
	printf("price for the art \'%s\' is %d\n", "Sunflowers", searchPrice(dict, "Sunflowers"));
	printf("price for the art \'%s\' is %d\n", "The Potato Eaters", searchPrice(dict, "The Potato Eaters"));
	printf("price for the art \'%s\' is %d\n", "Kiss", searchPrice(dict, "Kiss"));
	printf("price for the art \'%s\' is %d\n", "American Gothic", searchPrice(dict, "American Gothic"));
	printf("price for the art \'%s\' is %d\n", "Nighthawks", searchPrice(dict, "Nighthawks"));
	...
	while (arts[i])
	{
		if (searchPrice(dict, arts[i]->name) == -1)
		{
	...
	printf("Total number of art not found: %d\n", err);
	return (0);
}
