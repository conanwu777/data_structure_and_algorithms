...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "Sunflowers", searchPrice(arts, "Sunflowers"));
	printf("price for the art \'%s\' is %d\n", "The Potato Eaters", searchPrice(arts, "The Potato Eaters"));
	printf("price for the art \'%s\' is %d\n", "Kiss", searchPrice(arts, "Kiss"));
	printf("price for the art \'%s\' is %d\n", "American Gothic", searchPrice(arts, "American Gothic"));
	printf("price for the art \'%s\' is %d\n", "Nighthawks", searchPrice(arts, "Nighthawks"));
	printf("price for the art \'%s\' is %d\n", "Night Watch", searchPrice(arts, "Night Watch"));
	printf("Conclusion: Those prices are complete non-sense, perhaps from random number generator\n");
	while (*arts)
	{
		if (searchPrice(arts, (*arts)->name) == -1)
		{
			printf("Error: Art not found!!!\n");
			return (-1);
		}
		arts++;
	}
